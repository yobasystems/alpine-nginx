...
This Container image [(yobasystems/alpine-nginx)](https://hub.docker.com/r/yobasystems/alpine-nginx/) is based on the minimal [Alpine Linux](https://alpinelinux.org/) with version 1.29.0 of [NGINX](https://nginx.org/en/)


### Alpine Version 3.22.1 (Released 2025-07-15)
##### NGINX Version 1.29.0 (Mainline)
