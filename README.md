...
[![Nginx Version](https://img.shields.io/badge/Nginx%20Mainline-v1.17.5-green.svg?style=for-the-badge)](https://nginx.org/en/)
[![Nginx Version](https://img.shields.io/badge/Nginx%20Stable-v1.16.1-green.svg?style=for-the-badge)](https://nginx.org/en/)


This Docker image [(yobasystems/alpine-nginx)](https://hub.docker.com/r/yobasystems/alpine-nginx/) is based on the minimal [Alpine Linux](https://alpinelinux.org/) with version 1.17.5 of [NGINX](https://nginx.org/en/)

##### Alpine Version 3.10.3 (Released October 21, 2019)
##### NGINX Version 1.17.5 (Mainline)
